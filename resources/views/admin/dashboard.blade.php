        ...
        <div class="bg-gray-800/50 backdrop-blur-sm border border-gray-700/50 rounded-2xl p-6 relative overflow-hidden group hover:border-blue-500/30 transition-colors">
            ...
            <div class="flex items-center gap-4 relative z-10">
                ...
                <div>
                    ...
                    <h3 class="text-2xl font-bold text-white mt-1">12,483</h3>
                </div>
            </div>
        ...
        <div class="bg-gray-800/50 backdrop-blur-sm border border-gray-700/50 rounded-2xl p-6 relative overflow-hidden group hover:border-purple-500/30 transition-colors">
            ...
            <div class="flex items-center gap-4 relative z-10">
                ...
                <div>
                    ...
                    <h3 class="text-2xl font-bold text-white mt-1">4,231</h3>
                </div>
            </div>
            <div class="mt-4 flex items-center text-sm relative z-10">
                <span class="text-green-400 flex items-center gap-1 font-medium">
        ...
        <div class="bg-gray-800/50 backdrop-blur-sm border border-gray-700/50 rounded-2xl p-6 relative overflow-hidden group hover:border-emerald-500/30 transition-colors">
            ...
            <div class="flex items-center gap-4 relative z-10">
                ...
                <div>
                    ...
                    <h3 class="text-2xl font-bold text-white mt-1">$1,249</h3>
                </div>
            </div>
            <div class="mt-4 flex items-center text-sm relative z-10">
                <span class="text-green-400 flex items-center gap-1 font-medium">
            ...
            <table class="w-full text-left text-sm whitespace-nowrap">
                <thead class="bg-gray-900/50 text-gray-400 uppercase text-xs tracking-wider">
                    <tr>
                        ...
                        <th scope="col" class="px-6 py-4 font-medium">Issue Date</th>
                    ...
                    <tr class="hover:bg-gray-700/20 transition-colors">
                        <td class="px-6 py-4">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    <p class="font-medium text-white">The Great Gatsby</p>
                                    <p class="text-xs text-gray-500">ISBN: 978-0743273565</p>
                                </div>
                            </div>
                        </td>
                        <td class="px-6 py-4">
                            <div class="flex items-center gap-2">
                                <div class="w-6 h-6 rounded-full bg-blue-500/20 text-blue-400 flex items-center justify-center text-xs font-bold">JD</div>
                                <span>John Doe</span>
                            </div>
                        </td>
                        <td class="px-6 py-4">Today, 09:41 AM</td>
                    ...
                    <tr class="hover:bg-gray-700/20 transition-colors">
                        <td class="px-6 py-4">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    <p class="font-medium text-white">To Kill a Mockingbird</p>
                                    <p class="text-xs text-gray-500">ISBN: 978-0060935467</p>
                                </div>
                            </div>
                        </td>
                        <td class="px-6 py-4">
                            <div class="flex items-center gap-2">
                                <div class="w-6 h-6 rounded-full bg-purple-500/20 text-purple-400 flex items-center justify-center text-xs font-bold">AS</div>
                                <span>Alice Smith</span>
                            </div>
                        </td>
                        <td class="px-6 py-4">Yesterday</td>
                        <td class="px-6 py-4 text-red-400 font-medium">Oct 01, 2026</td>
                        <td class="px-6 py-4">
                    ...
                    <tr class="hover:bg-gray-700/20 transition-colors">
                        <td class="px-6 py-4">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    <p class="font-medium text-white">1984</p>
                                    <p class="text-xs text-gray-500">ISBN: 978-0451524935</p>
                                </div>
                            </div>
                        </td>
                        <td class="px-6 py-4">
                            <div class="flex items-center gap-2">
                                <div class="w-6 h-6 rounded-full bg-amber-500/20 text-amber-400 flex items-center justify-center text-xs font-bold">MR</div>
                                <span>Michael Ross</span>
                            </div>
                        </td>
                        <td class="px-6 py-4">Oct 05, 2026</td>
                        <td class="px-6 py-4">Oct 19, 2026</td>
                        <td class="px-6 py-4">
