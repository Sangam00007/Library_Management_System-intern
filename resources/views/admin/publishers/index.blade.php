                        ...
                        <tr class="even:bg-slate-50 hover:bg-slate-50 transition-colors">
                            ...
                            <td class="px-6 py-4 text-right">
                                <div class="flex items-center justify-end gap-2">
                                    ...
                                    <button type="button" @click="$dispatch('open-delete-modal', { action: '{{ route('admin.publishers.destroy', $publisher) }}', name: '{{ addslashes($publisher->name) }}' })" class="p-2 text-slate-500 hover:text-red-600 hover:bg-red-500/10 rounded-lg transition-colors" title="Delete">
