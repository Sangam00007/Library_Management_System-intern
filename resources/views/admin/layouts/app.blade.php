...
<body class="bg-gray-900 font-sans antialiased text-gray-100 flex min-h-screen overflow-hidden selection:bg-blue-500/30 selection:text-blue-200">
    ...
    <aside class="w-64 bg-gray-800/40 backdrop-blur-xl border-r border-gray-700/50 flex flex-col transition-all duration-300 relative z-20">
        ...
        <nav class="flex-1 overflow-y-auto py-4 px-3 space-y-1 custom-scrollbar">
            ...
            <a href="{{ route('admin.authors.index') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-lg {{ request()->routeIs('admin.authors.*') ? 'bg-blue-500/10 text-blue-400' : 'text-gray-400 hover:text-gray-200 hover:bg-gray-700/50' }} transition-all duration-200 group">
                <svg class="w-5 h-5 {{ request()->routeIs('admin.authors.*') ? 'text-blue-400' : 'text-gray-500 group-hover:text-gray-300' }} transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z"></path></svg>
            ...
            <a href="{{ route('admin.publishers.index') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-lg {{ request()->routeIs('admin.publishers.*') ? 'bg-blue-500/10 text-blue-400' : 'text-gray-400 hover:text-gray-200 hover:bg-gray-700/50' }} transition-all duration-200 group">
                <svg class="w-5 h-5 {{ request()->routeIs('admin.publishers.*') ? 'text-blue-400' : 'text-gray-500 group-hover:text-gray-300' }} transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"></path></svg>
            ...
            <a href="{{ route('admin.borrowings.index') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-lg {{ request()->routeIs('admin.borrowings.*') ? 'bg-blue-500/10 text-blue-400' : 'text-gray-400 hover:text-gray-200 hover:bg-gray-700/50' }} transition-all duration-200 group">
                <svg class="w-5 h-5 {{ request()->routeIs('admin.borrowings.*') ? 'text-blue-400' : 'text-gray-500 group-hover:text-gray-300' }} transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7h12m0 0l-4-4m4 4l-4 4m0 6H4m0 0l4 4m-4-4l4-4"></path></svg>
                <span class="font-medium text-sm">Borrowings</span>
            </a>
            <a href="{{ route('admin.fines.index') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-lg {{ request()->routeIs('admin.fines.*') ? 'bg-blue-500/10 text-blue-400' : 'text-gray-400 hover:text-gray-200 hover:bg-gray-700/50' }} transition-all duration-200 group">
                <div class="w-5 h-5 flex items-center justify-center font-bold text-[13px] leading-none {{ request()->routeIs('admin.fines.*') ? 'text-blue-400' : 'text-gray-500 group-hover:text-gray-300' }} transition-colors">Rs</div>
